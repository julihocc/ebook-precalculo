\section{Lógica matemática}
    ...
    \marginnote{En este curso, usaremos Python para desarrollar algunos ejercicios. Puedes encontrar el código fuente en el repositorio de este libro.}
...
\end{center}
 ...
 \begin{observacion}
  Para negar una afirmación del tipo $$\forall x \in A: p(x)$$ sólo necesitamos encontrar un elemento $x_{0}\in A$ tal que $p(x)$ sea \emph{falso.}
   ...
   A un elemento $x_{0}$ así se le conoce como \emph{contraejemplo.}
 \end{observacion}
...
\begin{center}
 \texttt{Lipschutz, S. and Lipson, M.; \textbf{Schaum's Outline of Discrete Mathematics;} McGraw-Hill, 3rd Edition.}
\end{center}
